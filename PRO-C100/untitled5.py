...
Original file is located at
    https://colab.research.google.com/drive/1t0-bNB5TnqoUSkZzaNkxKyjUUvFbVLLh
"""
...
class MovieReview:
    ...
    def avg_star_ratings(self, movie_list):
        for movie in movie_list:
            stars = '*' * movie["Avg Rating"]
            print(f"Thanks, You gave {movie['Movie Name']} {stars}")
            print(movie)


moviereviews = []

review1 = MovieReview("Runderm Alloc", 5, 5, 4)
